...
public class Config
{
    ...
    public static final String SERVER_IP = "http://123.30.100.120:6789";
    ...
    public static final String URL_POST_TEST= SERVER_IP+"/FileUploaderRESTService/rest/dktttb/posttest";
