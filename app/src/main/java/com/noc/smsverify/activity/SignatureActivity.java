        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (addJpgSignatureToGallery(signatureBitmap)) {
                    Toast.makeText(SignatureActivity.this, "Đã ký", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SignatureActivity.this, "Thất bại", Toast.LENGTH_SHORT).show();
                }
...
//                }
                ...
                resultIntent.putExtra("signpath", signpath);
...
//        });
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            ...
            signpath=photo.toString();
            Json.logi("signpath:"+signpath);
            scanMediaFile(photo);
            result = true;
        } catch (IOException e) {
            e.printStackTrace();
